...
export function getInfo(writer: string, space: string) {
  let condition: boolean;
  let err_msg: string;
  let response: any;
...
export function getBalance(writer: string, space: string) {
  let response: any;
  let method = new SASEUL.SmartContract.Method({
    type: "request",
    name: "GetBalance",
...
export function deposit(writer: string, space: string) {
  let condition: boolean;
  let err_msg: string;
  let update: any;
...
export function approve(writer: string, space: string) {
  let condition: boolean;
  let err_msg: string;
  let update: any;
...
export function cancel(writer: string, space: string) {
  let condition: boolean;
  let err_msg: string;
  let update: any;
...
export function getOrder(writer: string, space: string) {
  let condition: boolean;
  let err_msg: string;
  let response: any;
